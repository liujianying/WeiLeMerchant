...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
    	LogUitl.LogV(TAG, "This device does supports control of a flashlight");
    } else {
    	LogUitl.LogV(TAG, "This device does not support control of a flashlight");
    }
  }
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      return null;
    	...
    	LogUitl.LogW(TAG, "Unexpected error while finding class " + name);
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      return null;
    	...
    	LogUitl.LogW(TAG, "Unexpected error while finding method " + name);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      return method.invoke(instance, args);
    	...
    	LogUitl.LogW(TAG, "Unexpected error while invoking " + method);
      return null;
